...
env = "hml"  # Altere para "homolog" ou "prod" conforme necessário

# Configurações específicas para cada ambiente
config = {
    "homolog": {
        "app_name": "DataProcessingHomolog",
        "adls_container": "homolog-container",
        "adls_account": "seu_adls_account_name",
        "adls_key": "sua_adls_access_key",
        "input_path": "fake_dataset_homolog.csv",
        "output_path": "homolog/processed_data"
    },
}
