...
config = {
    "dev": {
        ...
        "adls_container": "dev-container",  # Nome do container no ADLS para DEV
        "adls_account": "seu_adls_account_name",
        "adls_key": "sua_adls_access_key",  # Utilize segredos no Key Vault em produção
        "input_path": "fake_dataset_dev.csv",  # Caminho no ADLS para os dados
